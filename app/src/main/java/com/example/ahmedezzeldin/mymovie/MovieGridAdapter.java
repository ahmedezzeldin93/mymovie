...
public class MovieGridAdapter extends BaseAdapter {
    ...
    private List<com.example.ahmedezzeldin.mymovie.Movie> moviesList;
    ...
    @Override
    public com.example.ahmedezzeldin.mymovie.Movie getItem(int position) {
    ...
    public void add(com.example.ahmedezzeldin.mymovie.Movie movie) {
    ...
    public void setData(List<com.example.ahmedezzeldin.mymovie.Movie> data) {
        clear();
        for (com.example.ahmedezzeldin.mymovie.Movie movie : data) {
            add(movie);
        }
...
//    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        com.example.ahmedezzeldin.mymovie.Movie movie = (com.example.ahmedezzeldin.mymovie.Movie)getItem(position);
